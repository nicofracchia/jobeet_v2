...
class jobActions extends sfActions
{
  ...
  {
        //$this->job = JobeetJobPeer::retrieveByPk($request->getParameter('id')); // ------> Llamada al objeto, es un find()

        $this->job = $this->getRoute()->getObject(); // -----> Objeto desde la ruta
        $this->forward404Unless($this->job);

        // $this->redirect($this->generateUrl('job_show_user', $job)); // -----> REDIRECT TO ROUTE
  }
